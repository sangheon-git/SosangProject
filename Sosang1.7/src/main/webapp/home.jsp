    ...
    <div id="sample-container">
        ...
        <div id="sample-result">
            ...
            <table id="sample-img-table">
                <tr>
                    <td><img id="sampleImg1" src="resources/images/sampleImg1.jpg"></td>
                    <td><img id="sampleImg2" src="resources/images/sampleImg2.jpg"></td>
                </tr>
                <tr>
                    <td><img id="sampleImg3" src="resources/images/sampleImg3.jpg"></td>
                    <td><img id="sampleImg4" src="resources/images/sampleImg4.jpg"></td>
                </tr>
            </table>
        </div>
    </div>
